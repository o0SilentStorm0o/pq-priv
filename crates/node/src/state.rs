...
mod tests {
    ...
    fn removes_confirmed_transactions_from_mempool() {
        ...
        let witness = Witness::new(Vec::new(), base_time + 1, (5_000u64).to_le_bytes().to_vec());
    ...
    fn reintroduces_reorged_transactions_in_dependency_order() {
        ...
        let parent_witness =
            Witness::new(Vec::new(), base_time + 1, (6_000u64).to_le_bytes().to_vec());
        ...
        let child_witness =
            Witness::new(Vec::new(), base_time + 2, (4_000u64).to_le_bytes().to_vec());
